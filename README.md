...
El juego se basa en turnos, con cada equipo moviéndose en secuencia, a través de terreno bidimensional. Durante un solo turno, un equipo solo puede mover uno de sus monos. Cuando todos los monos hayan completado su turno, empezará una ronda nueva manteniendo el orden de la ronda. Los monos pueden caminar y saltar, así como atacar a un mono enemigo. <br><br>
...
El juego incluye una gran variedad de ataques, incluyendo un ataque cuerpo a cuerpo y un proyectil. En una partida normal, todos los equipos empiezan con las mismas armas.<br><br>
...
+ <h4 id="mec"><b> Mecánicas</b></h4>
  ...
  * <h5><b><u> Agua</u></b></h5>El agua empezará la partida en la parte más baja de la pantalla e irá subiendo cada ronda que avance la partida a razón de 1 unidad por turno. 
...
+ <h4 id="mus"><b> Música y banda sonora</b></h4>
  Estilo de música muzak. <br> Efectos de sonido de explosion, lanzar objetos, patadas…

  <br>

+ <h4 id="esc"><b>  Escenarios</b></h4>Habrá 2 escenarios, los personajes estarán distribuidos en diferentes ubicaciones dentro de su área. Ambos escenarios comparten las mismas propiedades, tales como la destrucción del escenario. Habrá un plátano que deambula por el escenario.
...
+ <h4 id="acci"><b>  Acciones de Ataque </b></h4>Cada personaje dispondrá de un arsenal de armas, que hace de inventario. 
  ...
  * <h5><b> Granada </b></h5> Objeto que se lanza cuya trayectoria forma una parábola. Explota al contacto, generando un daño máximo de 20 en área, y destruyendo el mapa (si hay en el área de explosión). El número de granadas a usar depende de cuántas tenga cada personaje en su inventario. Todos los monos al iniciar la partida tienen una unidad de este objeto. La granada también es capaz de hacer daño al equipo amigo.
  
  <br>

  * <h5><b> Patada </b></h5> Ataque de rango cuerpo a cuerpo que realiza daño 10 con retroceso al mono que golpea
